...
\par Existing methods to measure latency within microseconds and nanoseconds require monolithic processes.
These can include setting up and installing device drivers, propietary software, or even a replacement of exisiting hardware systems.
This inflexibility is promeninent in many high end network performance analysis tools, causing delays in retrieving test results for evalutation.
